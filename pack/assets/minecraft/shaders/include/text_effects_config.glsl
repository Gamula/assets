...
TEXT_EFFECT(240, 240, 172) {
    apply_pink_fractal();
    textData.shouldScale = true;
}

TEXT_EFFECT(240, 240, 176) { // icy aurora
...
TEXT_EFFECT(240, 240, 180) { // mint delight
...
TEXT_EFFECT(240, 240, 184) { // summer sunshine
...
TEXT_EFFECT(240, 240, 188) { // wizard magic
...
TEXT_EFFECT(240, 240, 192) { // ocean blue
...
TEXT_EFFECT(240, 240, 196) { // pumpkin patch
...
TEXT_EFFECT(240, 240, 200) { // witch brew
...
TEXT_EFFECT(240, 240, 204) { // vampire kiss
...
TEXT_EFFECT(240, 240, 208) { // electric pulse
...
TEXT_EFFECT(240, 240, 216) { // golden sparkle
...
TEXT_EFFECT(240, 240, 220) { // candy cane
...
TEXT_EFFECT(240, 240, 224) { // poinsettia bloom
...
TEXT_EFFECT(240, 240, 228) { // sweet embrace
...
TEXT_EFFECT(240, 240, 232) { // enchanted evening
...
TEXT_EFFECT(240, 240, 236) { // scarlet passion
...
TEXT_EFFECT(240, 240, 244) { // pale rainbow fractal
    apply_pale_rainbow_fractal();
    textData.shouldScale = true;
}

TEXT_EFFECT(240, 240, 248) { // teal ocean
